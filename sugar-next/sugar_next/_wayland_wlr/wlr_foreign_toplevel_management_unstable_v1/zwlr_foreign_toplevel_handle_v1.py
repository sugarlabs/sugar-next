# This file has been autogenerated by the pywayland scanner, then hand-
# edited to import wl_output/wl_seat/wl_surface from the pywayland-bundled
# `wayland` core protocol instead of a locally generated copy, since we
# only vendor this one protocol's bindings (see sugar-next-next tasks.md,
# section 10). Re-run pywayland.scanner and reapply this edit if the
# upstream wlr-foreign-toplevel-management-unstable-v1.xml changes.
