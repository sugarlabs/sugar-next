...
Get jarabe (gtk4-port branch) importing, running, and rendering real
content against `sugar-toolkit-gtk4`, completing the environment/toolkit
integration that `windowed-jarabe` started but couldn't finish.
